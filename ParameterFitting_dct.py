...
for cur_pct in np.arange(0, 0.9, 0.1):
    ...
    fig_name = "mct_dct_data\\" + f'{pop_size:.0f}_' + trace_type + f'_{pct_dct * 100:.0f}%_'
    ...
    filename_save = file_dir + f'{pop_size:.0f}_' + trace_type + f'_{pct_dct * 100:.0f}%_' + 'estimated_parameters' + '.csv'
