...
for cur_eff in np.arange(0, 1.1, 0.1):
    ...
    fig_name = "mct_dct_data\\" + f'{pop_size:.0f}_' + trace_type + f'_{eff_mct:.1f}_'
    ...
    filename_save = file_dir + f'{pop_size:.0f}_' + trace_type + f'_{eff_mct:.1f}_' + 'estimated_parameters' + '.csv'
